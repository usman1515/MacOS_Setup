...
read -p "Install fd                 (Press y/n): " brew_fd
# prettify ls
...
read -p "Install fastfetch          (Press y/n): " brew_fastfetch
...
# ----------------------------------------------- installing fd
if [ $brew_fd == y ] || [ $brew_fd == Y ]
then
    echo -e "\n\n=============================================> Installing fd \n"
    brew install fd
else
    echo -e "\t SKIPPING fd installation"
fi
...
if [ $brew_fastfetch == y ] || [ $brew_fastfetch == Y ]
then
    echo -e "\n\n=============================================> Installing fastfetch \n"
    brew install fastfetch
else
    echo -e "\t SKIPPING fastfetch installation"
fi
# ----------------------------------------------- installing cmatrix
