...
read -p "Install meld               (Press y/n): " brew_meld
# terminals
...
read -p "Install notion             (Press y/n): " brew_notion
# image viewers
# cloud storage
...
# remote desktops
read -p "Install anydesk            (Press y/n): " brew_anydesk
read -p "Install vnc_viewer         (Press y/n): " brew_vnc_viewer
# games
...
# ----------------------------------------------- installing meld
if [ $brew_meld == y ] || [ $brew_meld == Y ]
then
    echo -e "\n\n=============================================> Installing meld \n"
    brew install --cask meld
else
    echo -e "\t SKIPPING meld installation"
fi
...
# ----------------------------------------------- installing notion
if [ $brew_notion == y ] || [ $brew_notion == Y ]
then
    echo -e "\n\n=============================================> Installing notion \n"
    brew install --cask notion
else
    echo -e "\t SKIPPING notion installation"
fi
...
# ----------------------------------------------- installing anydesk
if [ $brew_anydesk == y ] || [ $brew_anydesk == Y ]
then
    echo -e "\n\n=============================================> Installing anydesk \n"
    brew install --cask anydesk
else
    echo -e "\t SKIPPING anydesk installation"
fi
# ----------------------------------------------- installing vnc_viewer
if [ $brew_vnc_viewer == y ] || [ $brew_vnc_viewer == Y ]
then
    echo -e "\n\n=============================================> Installing vnc_viewer \n"
    brew install --cask vnc-viewer
else
    echo -e "\t SKIPPING vnc_viewer installation"
fi
